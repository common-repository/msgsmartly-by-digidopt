...
### Live chat 
MsgSmartly allows you to embed a free live chat module on your website and let site visitors chat with you. 
...
* Automated chatbot: create powerful scenario with by connecting the Dialogflow chatbot. Details [here](https://msgsmartly.com/dialog-flow-bot/).
...
It's fast and it works great. The MsgSmartly administration area is a progressive web app that can be installed on Windows and Macs. 
...
1. Register a new account at [https://chat.msgsmartly.com/](https://chat.msgsmartly.com/).
...
3. From the WordPress admin area go to Settings > MsgSmartly and insert the embed code of the chat (get it from https://chat.msgsmartly.com/account/).
4. Use the shortcode [msg-tickets] to display the ticket area. Use the shortcode [msg-articles] to display the articles area.

== FAQ ==

= Installation =

Register a new account at [https://chat.msgsmartly.com/](https://chat.msgsmartly.com/).
...
From the WordPress admin area go to Settings > MsgSmartly and insert the embed code of the chat (get it from https://chat.msgsmartly.com/account/).
Use the shortcode [msg-tickets] to display the ticket area. Use the shortcode [msg-articles] to display the articles area.

= What is MsgSmartly? =

MsgSmartly is a Platfrom by Digidopt that provides a customer messaging platform for small and medium companies to help them scale their customers relationship. Live Chat and the chatbot are two of the main features but not the only ones. Give them a try!

= Who should use MsgSmartly Live Chat? =

MsgSmartly is perfect for agencies, business owners, small businesses, bloggers, designers, anyone with a WordPress website and wants to use live chat on their website.

= Do I need coding skills to use MsgSmartly Wordpress plugin? =
...
The MsgSmartly's paid tiers are built for those who send a large volume of messages. For more details, [view our pricing page](https://msgsmartly.com/pricing).
...
https://msgsmartly.com/change-logs